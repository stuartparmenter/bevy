...
//!   the negotiated result reported from `WindowSurfaceTransfers::resolved`.
//!
//! ## Controls
//!
//! | Key             | Action                                                          |
...
use bevy::{
    ...
    window::{
        DisplayGamut, DisplayTarget, DisplayTransfer, PrimaryWindow, WindowSurfaceTransfers,
    },
...
struct NeonScene {
    ...
    /// `WindowSurfaceTransfers::resolved`.
    output: OutputMode,
    headlights_on: bool,
